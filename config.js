...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : '919517641203';
...
module.exports = {
  sessionName: process.env.SESSION_ID || "VAJIRA;;;VarsityOrderly
	",      //Put Your Session Id Here
  botname: process.env.BOT_NAME || 'Felix',
